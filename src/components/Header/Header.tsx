			...
			<Container maxWidth="lg">
				<HeaderInner>
					...
					<nav>
						<HeaderUl>
							<li>
								<HeaderLink to="character">{t('header.menu.character')}</HeaderLink>
							</li>
							<li>
								<HeaderLink to="races">{t('header.menu.races')}</HeaderLink>
							</li>
							<li>
								<HeaderLink to="classes">{t('header.menu.classes')}</HeaderLink>
							</li>
						</HeaderUl>
					</nav>
					<SelectStyle
